...
// Logging setup
log.setLevel(config.logLevels.package);
    ...
    return new Promise((resolve, reject) => {
      try {
        this.connectionLayer = new ConnectionLayer({
          downstreamMessageQueue: new MessageQueue(),
          upstreamMessageQueue: new MessageQueue(),
        });
        this.connectionLayer.connectToServer();
        this.connectionLayer.activateDownstreamMessageQueueListeners();
