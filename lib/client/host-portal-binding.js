...
class HostPortalBinding {
   ...
   * ID and broadcast the text update to all portal guests.
   */
   ...
   * characters in the interval [startPos, endPos), and then broadcast the text
   * updates to all portal guests.
   */
