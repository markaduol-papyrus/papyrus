...
class PortalListComponent {
  ...
  _renderGuestPortalBindingComponents() {
    ...
    let portalBindingComponents = [];
    for (const [guestPeerId, portalBinding] of this.props.guestPortalBindings) {
      portalBindingComponents.push($(GuestPortalBinding, {portalBinding}));
    }
