...
class HostPortalBindingComponent {
   ...
   * @param {Object} portalStore - PortalStore reference
      ...
      <div className="HostPortalComponent">
        ...
        <div className="HostPortalComponent-status">
          <ParticipantsComponent
           ...
           username={this.props.portalStore.getLocalUsername()}
          />
  ...
  async _toggleShare() {
    ...
    if (this.props.portalBinding) {
      ...
      const portalStore = this.props.portalStore;
      this.props.portalBinding =
        await portalStore.createAndSubscribeToHostPortalBinding();
